...
class ValidateRequest {
   ...
   */
  static String(param, min = 1, max = 100) {
    return Joi.string()
      .min(min)
      .max(max)
      .required()
   ...
   */
  static Password(param, joiObject) {
    return joiObject
      .string()
      .trim()
      .required()
   ...
   */
  static Number(param, joiObject, min = 1, max = 100) {
    return joiObject
      .number()
      .required()
      .messages({
   ...
   * @returns {Boolean} - True or false
   */
  static Enums(fields, param, joiObject) {
    return joiObject
      .string()
      .required()
      .valid(...fields)
